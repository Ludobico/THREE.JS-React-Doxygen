...
const FloatingRocks = () => {
  const rock1 = useLoader(
    GLTFLoader,
    process.env.PUBLIC_URL + "texture/model/floating_rock_1.glb"
  );
  const rock2 = useLoader(
    GLTFLoader,
    process.env.PUBLIC_URL + "texture/model/floating_rock_2.glb"
  );
  const rock3 = useLoader(
    GLTFLoader,
    process.env.PUBLIC_URL + "texture/model/floating_rock_3.glb"
  );
  return (
    <>
